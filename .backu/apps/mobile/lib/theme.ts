...
// CivicSense font system with Helvetica and Space Mono
export const fontFamily = {
  system: Platform.select({
    ios: 'Helvetica, -apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", Arial, sans-serif',
    android: 'Helvetica, Roboto, Arial, sans-serif',
  ...
  monoItalic: Platform.select({
    ios: 'SpaceMono-Italic',
    android: 'SpaceMono-Italic',
    default: 'SpaceMono-Italic',
  }),
  monoBoldItalic: Platform.select({
    ios: 'SpaceMono-BoldItalic',
    android: 'SpaceMono-BoldItalic',
    default: 'SpaceMono-BoldItalic',
  }),
  display: Platform.select({
    ios: 'Helvetica, -apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif',
    android: 'Helvetica, Roboto, sans-serif',
    default: 'Helvetica, sans-serif',
  }),
  text: Platform.select({
    ios: 'Helvetica, -apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif',
    android: 'Helvetica, Roboto, sans-serif',
    default: 'Helvetica, sans-serif',
  }),
} as const;
...
export const colorTokens = {
  // Light mode colors (converted from HSL in globals.css)
  light: {
    background: '#FFFFFF',           // hsl(0 0% 100%)
    foreground: '#020617',           // hsl(224 71% 4%)
    foregroundSecondary: '#64748B',  // hsl(215 20% 65%)
    foregroundTertiary: '#475569',   // hsl(215 16% 47%)
    foregroundMuted: '#F8FAFC',      // hsl(210 40% 96%)
    
    card: '#FFFFFF',                 // hsl(0 0% 100%)
    cardForeground: '#020617',       // hsl(224 71% 4%)
    
    // Primary - Modern electric blue
    primary: '#3B82F6',              // hsl(217 91% 60%)
    primaryForeground: '#FFFFFF',    // hsl(0 0% 100%)
    primaryLight: '#DBEAFE',         // Lighter tint
    primaryDark: '#1E40AF',          // Darker shade
    
    // Secondary - Subtle gray-blue
    secondary: '#E2E8F0',            // hsl(214 32% 91%)
    secondaryForeground: '#020617',  // hsl(224 71% 4%)
    
    // Muted - Light gray with blue tint
    muted: '#F8FAFC',                // hsl(210 40% 96%)
    mutedForeground: '#475569',      // hsl(215 16% 47%)
    
    // Accent - Vibrant cyan
    accent: '#0EA5E9',               // hsl(199 89% 48%)
    accentForeground: '#FFFFFF',     // hsl(0 0% 100%)
    accentLight: '#E0F2FE',          // Light cyan tint
    accentDark: '#0284C7',           // Darker cyan
    ...
    // Warning uses CivicSense primary blue
    warning: '#3B82F6',              // hsl(217 91% 60%)
    warningForeground: '#FFFFFF',    // hsl(0 0% 100%)
    warningLight: '#DBEAFE',         // Light blue tint
    
    // Interactive elements
    border: '#E2E8F0',               // hsl(214 32% 91%)
    input: '#E2E8F0',                // hsl(214 32% 91%)
    ring: '#3B82F6',                 // hsl(217 91% 60%)
    
    // Multiplayer theme (matching globals.css)
    multiplayerBg: '#FAFBFC',        // hsl(210 40% 98%)
    multiplayerCard: '#FFFFFF',      // hsl(0 0% 100%)
    multiplayerCardHover: '#F8FAFC', // hsl(210 40% 96%)
    multiplayerBorder: '#CBD5E1',    // hsl(214 32% 85%)
    multiplayerText: '#020617',      // hsl(224 71% 4%)
    multiplayerTextMuted: '#475569', // hsl(215 16% 47%)
    multiplayerAccent: '#3B82F6',    // hsl(217 91% 60%)
    multiplayerAccentLight: '#EFF6FF', // hsl(217 91% 95%)
    multiplayerSuccess: '#10B981',   // hsl(142 76% 36%)
    multiplayerSuccessLight: '#DCFCE7', // hsl(142 76% 95%)
    multiplayerWarning: '#3B82F6',   // hsl(217 91% 60%)
    multiplayerWarningLight: '#DBEAFE', // hsl(217 91% 95%)
  },
  
  // Dark mode colors (converted from HSL in globals.css)
  dark: {
    background: '#020617',           // hsl(224 71% 4%)
    foreground: '#F8FAFC',           // hsl(210 40% 98%)
    foregroundSecondary: '#64748B',  // hsl(215 20% 65%)
    foregroundTertiary: '#64748B',   // hsl(215 16% 65%)
    foregroundMuted: '#1E293B',      // hsl(217 33% 17%)
    
    card: '#0F172A',                 // hsl(217 33% 8%)
    cardForeground: '#F8FAFC',       // hsl(210 40% 98%)
    
    // Primary - Brighter blue for dark mode
    primary: '#60A5FA',              // hsl(217 91% 65%)
    primaryForeground: '#020617',    // hsl(224 71% 4%)
    primaryLight: '#1E3A8A',         // Darker in dark mode
    primaryDark: '#DBEAFE',          // Lighter in dark mode
    ...
    muted: '#1E293B',                // hsl(217 33% 17%)
    mutedForeground: '#64748B',      // hsl(215 20% 65%)
    
    // Accent - Bright cyan for dark mode
    accent: '#0EA5E9',               // hsl(199 89% 58%)
    accentForeground: '#020617',     // hsl(224 71% 4%)
    accentLight: '#0C4A6E',          // Darker in dark mode
    accentDark: '#E0F2FE',           // Lighter in dark mode
    
    // Status colors adjusted for dark mode
    destructive: '#DC2626',          // hsl(0 63% 31%)
    destructiveForeground: '#F8FAFC', // hsl(210 40% 98%)
    
    success: '#10B981',              // hsl(142 76% 46%)
    successForeground: '#F8FAFC',    // hsl(210 40% 98%)
    successLight: '#064E3B',         // Dark green tint
    
    // Warning uses CivicSense primary blue for dark mode
    warning: '#60A5FA',              // hsl(217 91% 65%)
    warningForeground: '#020617',    // hsl(224 71% 4%)
    warningLight: '#1E3A8A',         // Dark blue tint
    
    // Interactive elements
    border: '#1E293B',               // hsl(217 33% 17%)
    input: '#1E293B',                // hsl(217 33% 17%)
    ring: '#60A5FA',                 // hsl(217 91% 65%)
    
    // Multiplayer theme (matching globals.css dark mode)
    multiplayerBg: '#0F172A',        // hsl(224 71% 3%)
    multiplayerCard: '#0F172A',      // hsl(217 33% 8%)
    multiplayerCardHover: '#1E293B', // hsl(217 33% 12%)
    multiplayerBorder: '#334155',    // hsl(217 33% 20%)
    multiplayerText: '#F1F5F9',      // hsl(210 40% 95%)
    multiplayerTextMuted: '#94A3B8', // hsl(215 20% 60%)
    multiplayerAccent: '#60A5FA',    // hsl(217 91% 65%)
    multiplayerAccentLight: '#1E3A8A', // hsl(217 91% 15%)
    multiplayerSuccess: '#10B981',   // hsl(142 76% 46%)
    multiplayerSuccessLight: '#064E3B', // hsl(142 76% 12%)
    multiplayerWarning: '#60A5FA',   // hsl(217 91% 65%)
    multiplayerWarningLight: '#1E3A8A', // hsl(217 91% 12%)
  },
} as const;
...
export const lightTheme = {
  ...
  inputBorder: '#E2E8F0',        // Maps to border
...
export const darkTheme = {
  ...
  // Legacy color mappings for compatibility
  error: '#EF4444',              // Maps to destructive (dark mode)
  inputBorder: '#E2E8F0',        // Maps to border (dark mode)
  
  // Glass effects (minimal)
  glass: 'rgba(255, 255, 255, 0.1)', // Keep consistent with light theme
  overlay: 'rgba(0, 0, 0, 0.5)',
...
export const multiplayerBg = '#FAFBFC';        // hsl(210 40% 98%)
export const multiplayerCardBg = '#FFFFFF';    // Pure white for cards
export const multiplayerBorder = '#E1E5E9';    // hsl(210 20% 88%)
export const multiplayerText = '#1A202C';      // hsl(210 24% 16%)
export const multiplayerTextMuted = '#4A5568'; // hsl(210 22% 35%)
export const multiplayerAccent = '#3182CE';    // hsl(208 88% 50%)
export const multiplayerSuccess = '#38A169';   // hsl(146 68% 55%)
export const multiplayerWarning = '#ED8936';   // hsl(22 82% 60%)
export const multiplayerDanger = '#E53E3E';    // hsl(0 84% 60%)
export const multiplayerInfo = '#3182CE';      // hsl(208 88% 50%)
export const multiplayerLight = '#F7FAFC';     // hsl(210 40% 98%)
export const multiplayerDark = '#2D3748';      // hsl(210 25% 25%)
export const multiplayerPrimary = '#667EEA';   // hsl(231 48% 67%)
export const multiplayerSecondary = '#764BA2';  // hsl(270 31% 50%)
export const multiplayerGradientStart = '#667EEA'; // hsl(231 48% 67%)
export const multiplayerGradientEnd = '#764BA2';   // hsl(270 31% 50%)
export const multiplayerShadow = 'rgba(0, 0, 0, 0.1)';
export const multiplayerOverlay = 'rgba(0, 0, 0, 0.5)';
export const multiplayerHighlight = '#EBF8FF'; // hsl(208 100% 97%)
export const multiplayerWarningLight = '#DBEAFE'; // hsl(215 100% 92%)
