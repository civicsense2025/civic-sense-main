        ...
        <View style={styles.controlsContainer}>
          ...
          <ScrollView style={styles.scrollContent}>
            ...
            {(currentText || isPlayingTTS) && (
              <View style={styles.statusCard}>
                <Text style={styles.statusLabel}>
                  {isPlayingTTS ? (isPausedTTS ? uiStrings.audio.paused : uiStrings.audio.speaking) : 'Ready'}
                </Text>
                {currentText && (
            ...
            <View style={styles.mainControls}>
              ...
              >
                ...
                <Text style={styles.primaryButtonText}>
                  {isPlayingTTS ? (isPausedTTS ? uiStrings.audio.resume : uiStrings.audio.pause) : 
                   currentText ? uiStrings.audio.play : uiStrings.audio.readPage}
                </Text>
              </TouchableOpacity>
              ...
              >
                <Text style={styles.iconText}>🧪</Text>
                <Text style={styles.controlButtonText}>{uiStrings.audio.testAudio}</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.quickSettings}>
              ...
              <View style={styles.settingRow}>
                <View style={styles.settingLeft}>
                  <Text style={styles.iconText}>⚡</Text>
                  <Text style={styles.settingLabel}>{uiStrings.audio.autoPlay}</Text>
                </View>
                <Switch
              ...
              <View style={styles.settingRow}>
                <View style={styles.settingLeft}>
                  <Text style={styles.iconText}>🔁</Text>
                  <Text style={styles.settingLabel}>{uiStrings.audio.loop}</Text>
                </View>
                <Switch
                  value={loopEnabled}
              ...
              <View style={styles.settingRow}>
                <View style={styles.settingLeft}>
                  <VolumeIcon />
                  <Text style={styles.settingLabel}>{uiStrings.settings.soundEffects}</Text>
                </View>
                <Switch
            ...
            <View style={styles.translationSettings}>
              <Text style={styles.sectionTitle}>{uiStrings.translation.selectLanguage}</Text>
              ...
              <View style={styles.settingRow}>
                <View style={styles.settingLeft}>
                  <Text style={styles.iconText}>🌐</Text>
                  <Text style={styles.settingLabel}>{uiStrings.settings.language}</Text>
                </View>
