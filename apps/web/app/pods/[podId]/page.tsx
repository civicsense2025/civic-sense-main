  ...
  from: (table: string) => ({
    select: (fields: string) => ({
      eq: (field: string, value: string) => ({
        single: async () => ({ data: null, error: 'Stub implementation' })
      })
    })
  })
})
...
import { PodMemberManagement } from '@/components/learning-pods/pod-member-management'
import { PodActivityFeed } from '@/components/learning-pods/pod-activity-feed'
