...
const OnboardingFlow = ({ onComplete }: any) => (
  <div className="text-center p-8">
    <h2 className="text-2xl font-bold mb-4">Welcome to CivicSense!</h2>
    <p className="text-gray-600 mb-6">Onboarding flow temporarily disabled during migration</p>
    <button 
