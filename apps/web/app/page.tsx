...
export default function HomePage() {
  ...
  const handleContinueQuiz = useCallback((topicId: string) => {
    // Navigate to quiz for this topic
    router.push(`/quiz/${topicId}`)
  }, [router])

  const handleRestartQuiz = useCallback((topicId: string) => {
    // Navigate to quiz for this topic with restart flag
    router.push(`/quiz/${topicId}?restart=true`)
  }, [router])
