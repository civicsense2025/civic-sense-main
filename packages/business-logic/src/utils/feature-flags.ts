...
import type { AllFeatureFlags, NavigationFeatureFlags, PremiumFeatureFlags, CoreFeatureFlags } from './feature-flag-types';
...
export interface AllFeatureFlags {
  ...
  class EnvironmentFeatureFlags {
    ...
    private getEnvValue(key: keyof AllFeatureFlags): boolean {
