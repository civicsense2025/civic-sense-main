...
import { STRIPE_CONFIG } from '@civicsense/shared/lib/premium'
import { appleIAPMobile } from '@/apps/mobile/lib/apple-iap-mobile'
import { APPLE_IAP_PRODUCTS } from '@civicsense/shared/lib/apple-iap'
...
export function PremiumUpgradeScreen({ 
  ...
  const handleStripePurchase = async (plan: 'yearly' | 'lifetime') => {
    try {
      ...
      const { stripeOperations } = await import('@civicsense/shared/lib/premium')
