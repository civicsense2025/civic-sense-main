...
import { DB_COLUMNS, DB_TABLES } from './database-constants';
import { globalDataCache } from './global-data-cache';
import { GAME_SETTINGS } from './mobile-constants';
import type { QuizGameMetadata, QuizGameMode } from './quiz-types';
