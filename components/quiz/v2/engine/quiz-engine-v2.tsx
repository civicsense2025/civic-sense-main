...
import { MatchingInteractiveQuestion } from "../../question-types/matching-interactive"
import { TimelineQuestion } from "../../question-types/timeline"
import { FillInBlanksEnhancedQuestion } from "../../question-types/fill-in-blanks-enhanced"
import { ScenarioSimulationQuestion } from "../../question-types/scenario-simulation"
...
import { NetworkDiagramQuestion } from '../../question-types/network-diagram'
    ...
    <div className="relative min-h-screen bg-white dark:bg-slate-900">
          ...
          {isAnswerSubmitted && (
            <div className="space-y-6">
              <QuestionFeedbackDisplay
                question={currentQuestion as import("@/lib/quiz-data").QuizQuestion}
                selectedAnswer={selectedAnswer}
                timeLeft={timeLeft}
      ...
      {isAdmin && (
        <>
          ...
          {showAdminEdit && (
            <AdminEditPanel
              question={processedQuestions[currentQuestionIndex] as import("@/lib/quiz-data").QuizQuestion}
              topicId={topicId || ''}
              onQuestionUpdate={() => {}}
            />
          )}
