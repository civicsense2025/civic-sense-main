...
function hasOrderingItems(q: any): q is { ordering_items: OrderingItem[] } {
  return Array.isArray(q.ordering_items)
}
...
export function OrderingQuestion({ 
  ...
  // Use type guard for ordering_items
  const items: OrderingItem[] = hasOrderingItems(question) ? question.ordering_items : []

  // Fix all sort/map/filter parameter types
  const sortedItems = items.slice().sort((a: OrderingItem, b: OrderingItem) => a.currentPosition - b.currentPosition)
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {items.map((item: OrderingItem, index: number) => {
